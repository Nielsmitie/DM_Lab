...
def run_experiments(config, experiment_name, repeats, dataset='Prostate-GE'):
    ...
    """
    for id in [2, 5, 7, 10, 15, 20, 23, 30, 50, 70, 100, 200, 300, 500, 700, 1000, 2000, 3000]:
...
def parse_args():
    ...
    args.add_argument('--dataset', type=str, default='Prostate-GE')
...
if __name__ == '__main__':
    ...
    run_experiments(config, args.experiment_name, args.repeats, args.dataset)
